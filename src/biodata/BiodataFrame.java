...
public class BiodataFrame extends JFrame {
    ...
    public void refreshBiodataTable() {
        ...
        if (biodataList.isEmpty()) {
            ...
            for (Biodata biodata : biodataList) {
                System.out.println(biodata.getNama() + " "
    ...
    public void showAlertAllEmpty() {
        // Tampilkan message dialog pada komponen dari parameter 1 dan pesan 
        //pada parameter 2 dengan title pada parameter 3 dan jenis pesan pada parameter 4
    ...
    // Method untuk menampilkan alert ketika col tidak di pilih
    public void showAlertSelectedEmpty() {
        // Tampilkan message dialog pada komponen dari parameter 1 dan 
        //pesan pada parameter 2 dengan title pada parameter 3 dan jenis pesan pada parameter 4
        JOptionPane.showMessageDialog(BiodataFrame.this,
                "Pilih terlibih dahulu data!", "Perhatian",
                JOptionPane.WARNING_MESSAGE);
    }
